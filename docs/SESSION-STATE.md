...
- **Signage ambience (2026-09-10):** `/tv` plays procedural ocean + resonant sound-bath beds under occupied and vacant signage. Host CMS mute/volume/bed (`settings.ambience`). `?ambience=off` mutes. Videos stay muted. Independent of PR #149 Home overlay. See [`docs/AMBIENCE.md`](./AMBIENCE.md).
